...
const { getRepoRoot, getCompositionPackageChoices, packagePath } = require("../lib");
const {
  wireDataLoaderRegistryIntoCompositionInfrastructure,
  ensureCompositionDependsOnDataLoaderLib,
} = require("../lib/wire-dataloader-registry-in-composition-infra.cjs");

const repoRoot = getRepoRoot();

/** @param {import('plop').NodePlopAPI} plop */
module.exports = function registerCompositionWireDataLoaderRegistryGenerator(plop) {
