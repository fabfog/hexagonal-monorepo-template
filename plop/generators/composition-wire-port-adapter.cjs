...
const { scanPortImplementations } = require("../lib/scan-infrastructure-port-implementations.cjs");
const {
...
} = require("../lib/wire-port-adapter-in-composition-infra.cjs");
 ...
 */
function parseImplementationChoice(encoded) {
...
module.exports = function registerCompositionWirePortAdapterGenerator(plop) {
