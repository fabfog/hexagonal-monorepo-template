 ...
 * @param {{ className: string, interfaceName: string, methods: { name: string, params: string, returnType: string }[] }} params
 * @returns {string}
 */
function mergeAdapterContent(existing, { className, interfaceName, methods }) {
...
module.exports = { mergeAdapterContent, escapeRegExp };
