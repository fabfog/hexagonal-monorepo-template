 ...
 * @returns {string[]}
 */
function walkTsSourceFiles(dir) {
  /** @type {string[]} */
  const out = [];
 ...
 * @returns {number}
 */
function countRequiredConstructorParameters(classDecl) {
 ...
 * @param {string} name
 */
function isPortInterfaceName(name) {
 ...
 */
function findImportModuleForIdentifier(sf, identifierText) {
 ...
 */
function scanPortImplementations(repoRoot, infraFolder) {
