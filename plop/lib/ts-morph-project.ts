...
/**
 * Compiler options aligned with [plop/tsconfig.json](../tsconfig.json):
 * extends repo `base.json`, then plop overrides (ESNext + Bundler, no emit metadata).
 ...
 * across future migrations off the raw `typescript` API.
 */
