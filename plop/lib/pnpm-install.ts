 ...
 */
function runPnpmInstall(repoRoot: string) {
 ...
 */
function runPnpmInstallWithConsentOrThrow(
  repoRoot: string,
  opts: {
    context?: string;
  } = {}
...
export { isConfirmInstallEnabled, runPnpmInstall, runPnpmInstallWithConsentOrThrow, INSTALL_HINT };
