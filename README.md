...
- `pnpm demo:generate` – Generate the demo stack via Plop and run `pnpm install` with confirmation enabled
- `pnpm demo:remove` – Remove demo packages generated by `pnpm demo:generate`
