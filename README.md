...
- **Available generators** (match the names in the Plop menu):
  ...
  | `application-dto-mapper-for-entity` | Given a domain entity, create DTO + mapper in the matching application package (creates the app package if missing); updates dtos/mappers barrels and adds `@domain/<pkg>` dependency.                                                                 |
  | **Infrastructure**                  |                                                                                                                                                                                                                                                        |
